...
void script_knapsack(string type_inst, string taille, string WS_DM){
	...
	for(int i = 0; i < 10 ; i++){
		...
		for(int step = 0; step < 8; step++){
			...
			Tools::save_average_dist_time("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_MOLS1_onceWS.eval");
			Tools::save_average_indicator("./Data/ParetoFront/"+type_inst+"/I_"+taille+"_AVG_MOLS1_onceWS.front");


		}
		Tools::separate_results("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_MOLS1_onceWS.eval",type_inst+to_string(i)+"____");
		Tools::separate_results("./Data/ParetoFront/"+type_inst+"/I_"+taille+"_AVG_MOLS1_onceWS.front",type_inst+to_string(i)+"____");
	}
	...
	for(int i = 0; i < 10 ; i++){
		...
		for(int step = 0; step < 8; step++){
			...
			Tools::save_average_dist_time("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_MOLS2RAND.eval");
			Tools::save_average_indicator("./Data/ParetoFront/"+type_inst+"/I_"+taille+"_AVG_MOLS2RAND.front");


		}
		Tools::separate_results("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_MOLS2RAND.eval",type_inst+to_string(i)+"____");
		Tools::separate_results("./Data/ParetoFront/"+type_inst+"/I_"+taille+"_AVG_MOLS2RAND.front",type_inst+to_string(i)+"____");
	}
...
void script_Cst_PSize(string type_inst, string taille, string WS_DM){
	...
	for(int i = 1; i < 4; i++){
		...
		for(int iter = 10; iter <= 210 ; iter += 20){
			...
			Tools::separate_results("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_PS1_T"+to_string(i)+".eval",type_inst+to_string(i)+"___"+to_string(iter)+"__");
			Tools::separate_results("./Data/ParetoFront/"+type_inst+"/I_"+taille+"_AVG_PS1_T"+to_string(i)+".front",type_inst+to_string(i)+"___"+to_string(iter)+"__");
		}
	}
...
//					eval_ks->write_objective_OPT_information();
			...
			Tools::separate_results("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_PS2_T"+to_string(i)+".eval",type_inst+to_string(i)+"___"+to_string(iter)+"__");
			Tools::separate_results("./Data/ParetoFront/"+type_inst+"/I_"+taille+"_AVG_PS2_T"+to_string(i)+".front",type_inst+to_string(i)+"___"+to_string(iter)+"__");
		}
	}
