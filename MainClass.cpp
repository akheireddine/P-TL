...
list< shared_ptr<Alternative> > OPT_Solution;
...
void script_knapsack(string type_inst, string taille, string WS_DM){
	...
	string WS_matrix_file = "WS_MatrixA_UNLIMITED.csv";
...
//	vector<int> graines;
//
//	string WS_matrix_file = "WS_MatrixA_1.csv";
//	string prefix = "_AVG_PS_GENERATED_INST";
//	srand(time(NULL));
//
