...
//			,type_inst,taille,"MOLS1 - global update (fair)"," MOLS2 - local updates (unfair)",10,20);


	Gnuplotter::AllPlot_DIST_TIME_PSize("./Data/DistTime/"+type_inst+"/I_"+taille+"_AVG_PS2", type_inst, taille ,
			"MOLS1 - global update" , 10,  20);
