...
public:
	...
	static void DIST_TIME_PSize_RESUM_X(string filename, string type_inst, string size_inst,string algo,int init_size, int steps);
	static void INDICATORS_PSize_RESUM_X(string filename, string type_inst, string size_inst,string algo,int init_size, int steps);
