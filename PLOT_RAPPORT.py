...
#file_plot_static = [path+"/A/100/AVG_K_30.eval", path+"/C/100/AVG_K_20.eval"]
...
#file_plot_static = [path+"/A/100/AVG_K_30.evalPARETO", path+"/C/100/AVG_K_20.evalPareto"]
...
for i,l in zip(range(len(file_plot_static)), labels):
    ...
    if i == 0 :
        plt.plot(Xbudget_f1,Ymin,label="static method",marker='.',linewidth=2.0, color=colors[i], linestyle=':')
        plt.plot(Xbudget_f2,Ydyn,label=l,marker='.',linewidth=2.0, color=colors[i])
    else :
        plt.plot(Xbudget_f1,Ymin,marker='.',linewidth=2.0, color=colors[i])
        plt.plot(Xbudget_f2,Ydyn,marker='.',linewidth=2.0, color=colors[i])
