...
#plt.title("90 degré d'incertitude", fontweight="bold",size=15)
...
#plt.xlabel("Budget (# sol évalué)",size=15, fontweight="bold")
#plt.xlim(0,4020)
#plt.ylabel("Meilleure degré d'incertitude (°)",size=15, fontweight="bold")
#plt.ylim(-0.001, 91)
#
#for f,l in zip(file_plot,labels) : 
#    M = np.loadtxt(f)
...
#        
#    if l=="C-100" :
#        plt.plot(X, Y, label=l, marker='o',linewidth=6.0)
#    else:
#        plt.plot(X, Y, label=l, marker='o',linewidth=4.0)
#    
#    
...
#labels_v1 = ["sans information","sans information","sans information"]
#labels = ["avec information","avec information","avec information"]
#colors = ['tab:blue',"tab:orange","tab:green"]
#
#labelers = ["A-100","A-200","C-100"]
#
#for i in range(0,len(labelers)) :
#    fig = plt.figure(figsize=(6,5))
#
#    plt.minorticks_on()
#    plt.grid(which='both')
...
#    plt.title(labelers[i], fontweight="bold",size=25)
#    fig.savefig("Budget_D1_V1_"+labelers[i]+".png")
#
#    plt.show()
...
#    plt.title(labelers[i], fontweight="bold",size=25)
#
#    fig.savefig("Budget_D2_V1_"+labelers[i]+".png")
#    
#    plt.show()
...
#plt.title("90 degré d'incertitude", fontweight="bold",size=20,)
#fig.savefig("D1_PopSize_90.png")
#
#plt.show()
...
#labels_D1 = ["avec Diversification","avec Diversification"]
#labels= "A-100","C-100"
#
#
#
...
#    plt.plot(X0, Y0, label="sans Diversification", marker='o', color=colors[i], linewidth=4.0)
#
...
#        
#        
#    plt.plot(Xbudget_f1,Ymin,c="blue",label="Best PLS-I",marker='.',linewidth=2.0)
#    plt.plot(Xbudget_f1,Ymax,c="red",label="Worst PLS-I",marker='.',linewidth=2.0)
#    plt.plot(Xbudget_f2,Ydyn,c="green",label="PLS$_{ML}$",marker='.',linewidth=2.0)
#        
#    plt.grid()
#    plt.legend(prop={'size': 20})
...
#        
#    plt.plot(Xbudget_f1,Ymin,c=colors[i],label="PLS-I ("+labels[i]+")",marker='.',linewidth=3.0,linestyle=":")
#    plt.plot(Xbudget_f2,Ydyn,c=colors[i],label="PLS$_{ML}$",marker='.',linewidth=3.0)
#        
#plt.grid()
#plt.legend(prop={'size': 20})
...
#        Ymax.append(np.log(avg_maxus/ nb_instance))
#        
#    for b in Xbudget_f2: #[60,540,2020,4020] : #Xbudget_f2  :
#
#        for row in Smallreader : 
#            if int(row['Budget']) == b and int(float(row['Diversification'])) == div and int(float(row['PopSize'])) == PopSize[i] :
#                Ydyn.append(np.log(float(row['AVG_dist'])))
...
#    plt.plot(Xbudget_f1,Ymin,c="blue",label="Best PLS-I",marker='.',linewidth=2.0)
#    plt.plot(Xbudget_f1,Ymax,c="red",label="Worst PLS-I",marker='.',linewidth=2.0)
#    plt.plot(Xbudget_f2,Ydyn,c="green",label="PLS$_{dyn}$",marker='.',linewidth=2.0)
#        
#    plt.grid()
#    plt.legend(prop={'size': 20})
#    plt.title(l,fontsize=15,fontweight="bold")
...
#    Ydyn = list()
#
#    for b in [60,540,1220,6020] : #[60,540,1220,6020] : #Xbudget_f1  :
#        Ytmp = list()
#
#        for row in Bigreader:
...
#file_plot_static = [path+"/A/100/K_30.evalPARETO", path+"/C/100/K_20.evalPareto"]
#file_plot_dyn = [path+"/A/100/AVG_K_10.evalRAPPORT_MULTIPARAM", path+"/C/100/AVG_K_10.evalRAPPORT_MULTIPARAM"]
#
#nb_instance=10
#labels= "A-100","C-100"
#
...
#    plt.plot(Xbudget_f1,Ymin,c="blue",label="Best PLS-I",marker='.',linewidth=2.0)
#    plt.plot(Xbudget_f1,Ymax,c="red",label="Worst PLS-I",marker='.',linewidth=2.0)
#    plt.plot(Xbudget_f2,Ydyn,c="green",label="PLS$_{2L}$",marker='.',linewidth=2.0)
#        
#    plt.grid()
#    if l =="A-100" :
